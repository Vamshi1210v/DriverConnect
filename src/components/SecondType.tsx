    ...
    <View style={styles.container}>
      <Animated.View
        ...
        <View style={styles.iconContainer}>
          <Image
            source={require('../assests/images/PenIcon.png')}
            style={styles.icon}
          />
        </View>
      ...
      <Animated.View
        ...
        <View style={styles.iconContainer}>
          <Image
            source={require('../assests/images/FileIcon.png')}
            style={styles.icon}
          />
        </View>
        <Animated.Text style={[styles.text, opacityText]}>
      ...
      <Animated.View
        ...
        <View style={styles.iconContainer}>
          <Image
            source={require('../assests/images/FolderIcon.png')}
            style={styles.icon}
          />
        </View>
        <Animated.Text style={[styles.text, opacityText]}>
      ...
      <Pressable
        ...
        <Animated.View style={[styles.iconContainer, plusIcon]}>
          <Image
            source={require('../assests/images/PlusIcon.png')}
            style={styles.icon}
          />
        </Animated.View>
      </Pressable>
